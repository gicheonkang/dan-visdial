...
parser.add_argument('-download', default = True, help='Whether to download VisDial v1.0 data')
...
# Output files
parser.add_argument('-output_json', default='visdial_1.0_params.json', help='Output json file')
parser.add_argument('-output_h5', default='visdial_1.0_data.h5', help='Output hdf5 file')
...
# don't need to know the full path of image
...
if __name__ == "__main__":
    ...
    out['unique_img_train'] = get_image_ids(data_train)
    out['unique_img_val'] = get_image_ids(data_val)
    out['unique_img_test'] = get_image_ids(data_test)
    if args.train_split == 'trainval':
